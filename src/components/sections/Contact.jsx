          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="mil-input-frame mil-mb-30">
                <label htmlFor="home-contact-name">
              ...
              <div className="mil-input-frame mil-mb-30">
                <label htmlFor="home-contact-email">
              ...
              <div className="mil-input-frame mil-mb-60">
                <label htmlFor="home-contact-phone">
            ...
            <div className="col-lg-6">
              <div className="mil-input-frame mil-mb-30">
                <label htmlFor="home-contact-message">
              ...
              <div className="mil-checbox-frame mil-mb-60">
                <input
                  ...
                  id="home-contact-news"
                  type="checkbox"
                  checked={marketingOptIn}
                  onChange={(e) => setMarketingOptIn(e.target.checked)}
                />
                <label
                  htmlFor="home-contact-news"
