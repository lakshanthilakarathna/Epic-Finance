        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-xl-8">
              ...
              {Content.stats && (
                <div className="mil-hero-stats-bg">
                  {Content.stats.map((stat, key) => (
                    <div className={`mil-hero-stat mil-hero-stat-${key + 1}`} key={`stat-${key}`}>
                      <span className="mil-hero-stat-number">{stat.number}</span>
                      <span className="mil-hero-stat-label">{stat.label}</span>
                    </div>
                  ))}
                </div>
              )}
            ...
            <div className="col-xl-4">
              <div className="mil-illustration-1">
                ...
                <div className={`mil-item mil-item-${key+1}`} key={`item-${key}`}>
